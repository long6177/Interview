...
#### SQL题：给定一个学生表 studentscore（stuid，subject_id，score），查询总分排名在5-10名的学生id及对应的总分
...
#### 联合索引(a,b,c)，查询条件 `where b > xxx and a = x` / `where a = x and b > xxx` 会生效吗
